...
import 'package:testlogin/widget/widget.dart';
...
class _SearchState extends State<Search> {
  ...
  void initState() {
    super.initState();
    searchEditingController.text = widget.username;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Chat"), backgroundColor: Colors.amberAccent,),
      body: isLoading
